%% ==============================================
%% To compile this syllabus:
%% 1. Use LuaLaTeX (Overleaf: Menu → Compiler → LuaLaTeX)
%% 2. Make sure "csuf_logo.png" is in the same folder
%% 3. If you see errors about fonts or tagpdf, update TeX Live
%% ==============================================
...
% Main font (default for body text)
\IfFontExistsTF{TeX Gyre Heros}{
  \setmainfont{TeX Gyre Heros} % Sans serif for main text
}{
  \setmainfont{Latin Modern Sans} % Fallback to Latin Modern Sans
}
