...
\setmainfont{TeX Gyre Heros} % Set main font to TeX Gyre Heros
\setsansfont{TeX Gyre Heros} % Set sans-serif font to TeX Gyre Heros
\setmonofont{TeX Gyre Cursor} % Set monospaced font to TeX Gyre Cursor
...
\tagpdfsetup{
  activate-all=true,   % Activate tagging for all elements
  interwordspace=true  % Improve word boundary information for assistive technology
}
