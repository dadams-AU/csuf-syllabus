...
\hypersetup{
  ...
  pdftitle={\CourseCode: \CourseTitle}, % Set PDF title
  pdfauthor={\InstructorName},           % Set PDF author
  pdfkeywords={CSUF, Syllabus, Accessibility, \DepartmentKeywords, \CourseCode}, % Set PDF keywords
...
% ================================
% These fields are used for BOTH the visible title and the PDF metadata.
\newcommand{\CourseCode}{PREFIX\ 100}
\newcommand{\CourseTitle}{Title}
\newcommand{\CourseTerm}{Semester, Year}
