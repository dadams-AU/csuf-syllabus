...
\UseTblrLibrary{booktabs} % nice rules, no vertical bars

% Tagging (kernel-friendly)
\usepackage{tagpdf}
\tagpdfsetup{
  activate-all=true,   % turn on tagging
  interwordspace=true  % better word boundary info for AT
}

% Colors (keep just one xcolor)
\usepackage{xcolor}
% High-contrast annotation colors (WCAG AA on white)
\definecolor{annotationblue}{RGB}{0,77,153} % #004D99
\definecolor{suggestionred}{RGB}{153,0,0}   % #990000
...
\setlistdepth{3}
% Example alt text: \includegraphics[width=2.75in, alt={Cal State Fullerton wordmark}]{csuf_logo.png}
