...
\author{}  % instructor info goes in the body
\date{Term and Year}

% Accessibility niceties
\setlistdepth{3}                 % consistent list tagging
% Alt text example: \includegraphics[width=2.75in, alt={Cal State Fullerton wordmark}]{csuf_logo.png}
