...
% Font settings (LuaLaTeX-native fonts)
\usepackage{fontspec} % Package for font customization
% Check and set main font
\IfFontExistsTF{TeX Gyre Termes}{
  \setmainfont{TeX Gyre Termes} % Use TeX Gyre Termes if available
}{
  \setmainfont{Latin Modern Roman} % Fallback to Latin Modern Roman
}
% Check and set sans-serif font
\IfFontExistsTF{TeX Gyre Heros}{
  \setsansfont{TeX Gyre Heros} % Use TeX Gyre Heros if available
}{
  \setsansfont{Latin Modern Sans} % Fallback to Latin Modern Sans
}
% Check and set monospaced font
\IfFontExistsTF{TeX Gyre Cursor}{
  \setmonofont{TeX Gyre Cursor} % Use TeX Gyre Cursor if available
}{
  \setmonofont{Latin Modern Mono} % Fallback to Latin Modern Mono
}
